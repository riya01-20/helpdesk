                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6"
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="rememberMe" className="h-4 w-4 text-blue-800 focus:ring-blue-500 border-gray-300 rounded" />
                    ...
                    <p className="mt-4 text-center text-sm text-gray-500">
                        ...
                        <button onClick={() => navigate('/signup')} href="#" className="font-semibold leading-6 text-blue-800 hover:text-blue-500">
                            Sign up
                        </button>
                    </p>
                </div>
